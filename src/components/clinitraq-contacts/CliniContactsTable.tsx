...
const CliniContactsTable = () => {
    ...
    const fetchOrders = async (page: number, limit: number, leadType?: string) => {
        ...
        const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_API}/api/clini/contact/all?page=${page}&limit=${limit}&leadType=${leadType}`, {
            method: "GET",
            headers: {
...
export default CliniContactsTable;
